    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-5 duration-700 bg-sky-50 min-h-screen p-6 md:p-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h2 className="text-4xl font-display font-black text-slate-800 tracking-tight uppercase">
            ...
            <div className="bg-white/50 backdrop-blur-xl border border-sky-100 rounded-[3rem] p-10 flex flex-col lg:flex-row gap-12 items-center lg:items-start relative overflow-hidden group shadow-2xl">
                ...
                <div className="relative">
                    <div className="w-40 h-40 rounded-[2.5rem] p-1.5 bg-gradient-to-tr from-indigo-500/20 to-indigo-500/5 shadow-2xl">
                        <div className="w-full h-full rounded-[2rem] bg-sky-50 overflow-hidden border-4 border-sky-100 flex items-center justify-center text-5xl font-display font-black text-sky-500 uppercase shadow-inner">
                            {user?.name?.charAt(0)}
                        </div>
                    </div>
                    <motion.div
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="flex flex-col justify-between items-end gap-6 text-right">
                        ...
                        <button onClick={() => navigate('/settings')} className="px-8 py-3.5 bg-sky-500 text-slate-800 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-sky-600/20 hover:bg-sky-700 transition-all active:scale-95">Synchronize Profile</button>
                    </div>
                </div>
            </div>
