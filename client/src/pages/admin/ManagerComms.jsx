    ...
    return (
        <div className="flex flex-col h-[calc(100vh-100px)]">
            <div className="mb-6 shrink-0">
                <h1 className="text-3xl font-display font-black text-slate-800 tracking-tight uppercase">Team<span className="text-sky-500">.Comms</span></h1>
            ...
            <div className="flex-1 min-h-0 bg-white/50 backdrop-blur-xl border border-sky-100 rounded-[2rem] shadow-2xl flex overflow-hidden">
                {/* Left Pane - Roster */}
                <div className="w-1/3 min-w-[280px] max-w-[380px] border-r border-sky-100 bg-sky-50/30 flex flex-col h-full">
                    ...
                    {selectedEmployee ? (
                        <div className="h-full flex flex-col relative w-full pt-16">
                            <div className="absolute top-0 left-0 w-full bg-sky-50/50 backdrop-blur-xl border-b border-sky-100 p-4 shrink-0 flex items-center gap-3 z-20 h-16">
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-slate-800 leading-tight uppercase tracking-tight">{selectedEmployee.name}</h3>
