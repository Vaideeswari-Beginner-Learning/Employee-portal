                    ...
                    <table className="w-full text-left border-collapse min-w-[1000px]">
                        <thead>
                            <tr className="bg-white/5">
                                ...
                                <th className="px-8 py-5 text-[10px] font-black text-slate-500 uppercase tracking-[0.15em] border-b border-white/5">Staff Identity</th>
                                <th className="px-8 py-5 text-[10px] font-black text-slate-500 uppercase tracking-[0.15em] border-b border-white/5">Department</th>
                                <th className="px-8 py-5 text-[10px] font-black text-slate-500 uppercase tracking-[0.15em] border-b border-white/5">Duty Type</th>
                ...
                {showModal && (
                    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-6 z-[100]">
                        <motion.div
                            ...
                            className="bg-slate-900 rounded-[2.5rem] w-full max-w-xl shadow-[0_40px_100px_-20px_rgba(0,0,0,0.8)] relative overflow-hidden border border-white/10"
                        >
                            <div className="px-10 py-8 border-b border-white/5 flex justify-between items-center bg-white/5">
                                ...
                                <button
                                    ...
                                    className="w-12 h-12 rounded-2xl bg-white/5 text-slate-500 hover:text-red-400 hover:bg-red-500/10 transition-all flex items-center justify-center group border border-white/5"
                                >
                            ...
                            <form onSubmit={handleSubmit} className="p-10 space-y-8">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                    <button
                                        ...
                                        type="button"
                                        className="flex-1 py-4 text-[10px] font-black text-slate-400 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-all uppercase tracking-[0.2em]"
                                    >
                                        Abort Sync
                                    </button>
